...
if __name__ == '__main__':
    ...
    student_marks = {}
    for _ in range(n):
        name, *line = input().split()  # used to unpack the list into individual elements, where the first element is
        # assigned to name, and the remaining elements are packed into the line list.
